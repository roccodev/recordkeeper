...
gauntlet_save_score = Current Score
gauntlet_save_stone = Current Reward (Noponstone)
gauntlet_save_no_ko = No-KO Streak
gauntlet_save_purchase_hero = Purchase Count (Hero)
gauntlet_save_purchase_watch = Purchase Count (Nopwatch)
